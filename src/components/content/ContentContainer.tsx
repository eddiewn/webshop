...
const ContentContainer = ({filterChamp, startIndex, setStartIndex, setCart, cart,filterSpecificSkin}: Props) => {
...
return(
    <section className="flex gap-6 flex-col lg:flex-row justify-between w-9/10 m-auto">
        ...
        <ContentProducts filterChamp={filterChamp} startIndex={startIndex} setStartIndex={setStartIndex} setCart={setCart} cart={cart} rarityFilter={rarityFilter} filterSpecificSkin={filterSpecificSkin}/>
    </section>
)
}
